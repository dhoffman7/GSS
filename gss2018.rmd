...
The three questions require the same coding in the numerical, inferential, graphical desciptive results you just have to change the variables.In all the data it totals up to a 100.All three questions want to know what individuals oppose or favor the variables. 
